                          ...
                          <tr key={index}>
                            <td className="product_remove">
                              <i
                                ...
                                onClick={() => rmProduct(data.cartDetailsId)}
                                style={{ cursor: "pointer" }}
                              ></i>
                            </td>
                            <td className="product_thumb">
                              <Link
                                to={`/product-details-one/${data.productId}`}
                              >
                                <img
                                  src={"/assets/images/" + data.product.img}
                                  alt="img"
                                />
                              </Link>
                            </td>
                            ...
                            <td className="product_total">
                              {data.product.price * (data.count || 1)}.00 TL
                            </td>
                          </tr>
                        ))}
                      </tbody>
